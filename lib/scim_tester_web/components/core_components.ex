defmodule ScimTesterWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ScimTesterWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ScimTesterWeb.Gettext, "errors", msg, opts)
    end
  end
